        ...
        <div className="space-y-6 md:space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 leading-relaxed max-w-md">
              Upload your photo, choose any outfit, and instantly see how they look on you—no guessing, no returns, no hassle.
            </p>
          </div>
          ...
          <div className="space-y-3 text-gray-600 dark:text-gray-400">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg">Transform your fashion decisions in seconds</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="text-2xl">🛍️</span>
              <span className="text-lg">Try unlimited combinations instantly</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="text-2xl">🔒</span>
              <span className="text-lg">Your photos stay completely private</span>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 pt-4">
            <Link href="/dashboard">
              <Button
                className="w-full md:w-auto bg-gradient-to-r from-pink-500 to-rose-500 text-white font-bold text-lg px-8 hover:shadow-2xl transition-all hover:scale-105"
              >
                Try Now - It's Free
              </Button>
            </Link>
